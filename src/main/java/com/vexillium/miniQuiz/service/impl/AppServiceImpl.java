...
import com.vexillium.miniQuiz.mapper.AppMapper;
...
import com.vexillium.miniQuiz.model.enums.AppScoringStrategyEnum;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public void validApp(App app, boolean add) {
        ...
        if (add) {
            ...
            ThrowUtils.throwIf(appScoringStrategyEnum == null, ErrorCode.PARAMS_ERROR, "计分策略非法");
        }
        // 修改数据时，有参数则校验
        // 补充校验规则
